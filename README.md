...
[![npm downloads](https://img.shields.io/npm/dm/ngx-datatable-af.svg)](https://npmjs.org/ngx-datatable-af)
...
To use ngx-datatable in your project install it via [npm](https://www.npmjs.com/package/ngx-datatable-af):

```
npm i ngx-datatable-af --save
```
